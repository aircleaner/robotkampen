...
#define TICKTOMM 37
#define TICK90DEG 270*2-60 //234

#define MOVE_WATER_MOTOR 50
...
#define COMMAND_LENGTH 8*2

//int path[COMMAND_LENGTH] = { FLIP, 300};
int path[COMMAND_LENGTH] = { FORWARD, 400, RIGHT, 0, FORWARD, 850, FLIP, 0, SLEEP, 100, FLIP, 0, SLEEP, 100, FLIP, 0};
